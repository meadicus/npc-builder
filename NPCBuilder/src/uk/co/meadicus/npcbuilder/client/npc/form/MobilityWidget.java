...
public class MobilityWidget extends Composite {
	...
	private static MobilityWidgetUiBinder uiBinder = GWT
			.create(MobilityWidgetUiBinder.class);

	interface MobilityWidgetUiBinder extends UiBinder<Widget, MobilityWidget> {
	}

	@UiField ListBox motionTypeListBox;
	@UiField ListBox walkerSpeedListBox;
	@UiField ListBox burrowerSpeedListBox;
	@UiField ListBox flyerSpeedListBox;
	@UiField ListBox swimmerSpeedListBox;
	@UiField Panel speedEditArea;
	...
	public MobilityWidget(final ChangeHandler changeHandler) {
		...
		motionTypeListBox.addChangeHandler(new ChangeHandler() {
			@Override
	...
	private void setupSpeedListBox(ListBox listBox,
