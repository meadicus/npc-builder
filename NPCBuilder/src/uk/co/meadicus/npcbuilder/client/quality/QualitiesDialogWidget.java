...
public class QualitiesDialogWidget extends Composite {
	...
	private static QualitiesDialogWidgetUiBinder uiBinder = GWT
			.create(QualitiesDialogWidgetUiBinder.class);

	interface QualitiesDialogWidgetUiBinder extends
			UiBinder<Widget, QualitiesDialogWidget> {
	}
	
	private final NPC npc;
	
	@UiField ListBox newQualityListBox;
	@UiField Button addButton;
	@UiField ListBox editQualityListBox;
	@UiField Button editButton;
	@UiField Button removeButton;
	@UiField Label customQualityNote;
	
	public QualitiesDialogWidget(final NPC npc, final NPCEditor npcEditor, final QualitiesDialogBox qualitiesDialogBox) {
		...
		NPCUtils.addListOptionGroups(this.newQualityListBox,
									true,
									allQualities);
		...
		this.editButton.addClickHandler(new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				editSelectedQuality(npcEditor, qualitiesDialogBox);
			}
		...
		this.editQualityListBox.addDoubleClickHandler(new DoubleClickHandler() {
			@Override
	...
	private void editSelectedQuality(final NPCEditor npcEditor,
	...
	public void init() {
		...
		NPCUtils.addListOptions(this.editQualityListBox,
								true,
								qualityListItems,
								false);
